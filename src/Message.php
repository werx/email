<?php
namespace werx\Email;

/**
 * Send Email
 *
 * This is a port of the CodeIgniter email class updated for autoloading and to not rely on the CI global.
 * Original code licensed under OSL 3.0. See bottom of this file for license.
 *
 * See docs at http://ellislab.com/codeigniter/user-guide/libraries/email.html
 */
class Message {
	 ...
	 * @var	string
	 */
	public $useragent	= 'X-Mailer: werx';
	...
	/**
	 * Added this magic method to allow for some unit testing.
	 *
	 * @param type $name
	...
	public function __call($name, $arguments=null)
	{
		if (substr($name, 0, 3) == 'get') {
			$property = strtolower('_' . str_replace('get', '', $name));
